...
const Top = () => {
    return (
        <div className='hidden md:grid grid-cols-12 p-1 px-4 bg-neutral'>
            <div className="flex justify-start items-center col-span-4">
                ...
                <a href="https://wa.link/v70rkd" target='_blank'>+8801309054202</a>
                </p>
                ...
                <a href="mailto:admin@barirdokan.com">admin@barirdokan.com</a>
                </p>
            </div>
            ...
            <div className="col-span-4 flex items-center justify-end">
                <Link href='https://www.facebook.com/barirdokan.bd/' target='_blank'>
                ...
                <Link href='https://www.instagram.com/barirdokan.bd/' target='_blank'>
                ...
                <Link href='https://www.threads.net/@barirdokan.bd'>
